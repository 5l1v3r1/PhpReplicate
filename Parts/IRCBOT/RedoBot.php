<?php
/* kurtcc
Yes this code looks ugly but just want to see if it works, will make code more elegant later and add error handling, right now let's assume everything 
just works fine. Ok? Great. */
...
// Just few random commands that will give output, I'll add the nasty commands later with arguments
			// THis is work in progress.
			// Output is still probably just one word, should try get a way of formatting output better and preserving spaces.
			// This is just a test of some of the code I am going to use so everything is just ugly, the code in /Parts is also
			// just pieces of code I was testing.
